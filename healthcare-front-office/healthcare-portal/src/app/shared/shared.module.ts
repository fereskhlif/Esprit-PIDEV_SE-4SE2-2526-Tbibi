...
import { Share2, Edit3, ChevronDown } from 'lucide-angular';
...
import { CornerDownRight } from 'lucide-angular';
import {
    LucideAngularModule,
    LayoutDashboard,
    User,
...
@NgModule({
    ...
    imports: [
        ...
        LucideAngularModule.pick({
            ...
            ShoppingCart, Package, Eye, Loader2, Check, CheckCircle, AlertCircle, ChevronLeft, SearchX, Truck, Filter, ArrowUpDown,
            // Forum Home
